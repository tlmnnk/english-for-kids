const cards = [ 
  ['Action (set A)', 'Action (set B)', 'Animal (set A)', 'Animal (set B)', 'Clothes', 'Emotions', 'Computers', 'Food'],
  [
    {
      word: 'cry',
      translation: 'плакать',
  ...
  [
    ...
    },
    {
      word: 'mouse',
      translation: 'мышь',
      image: 'img/computer-mouse.jpg',
      audioSrc: 'audio/mouse.mp3'
    },
    {
      word: 'drive',
      translation: 'диск, привод',
      image: 'img/drive.jpg',
    ...
    },
    {
      ...
      audioSrc: 'audio/speakers.mp3'
    },
    {
      word: 'motherboard',
      translation: 'Материнская плата',
      image: 'img/motherboard.jpg',
      audioSrc: 'audio/motherboard.mp3'
    },
    {
      word: 'to crack',
      translation: 'взломать',
      image: 'img/crack.jpg',
      audioSrc: 'audio/crack.mp3'
    },
  ],
  [
    {
